...
enum EndPoint: String {
    ...
    case mostRecentPhotos = "flickr.photos.getRecent"
}
...
struct FlickrAPI {
    ...
    static var mostRecentPhotosURL: URL {
        return flickrURL(endPoint: .mostRecentPhotos, parameters: ["extras": "url_z,date_taken"])
    }
